            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto ml-5">
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('educations') ? 'active' : '' }}" href="{{ route('educations.index') }}">Educations</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('classes') ? 'active' : '' }}" href="{{ route('classes.index') }}">Classes</a>
                        </li>
                        <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    @if (Auth::user()->student_id !== null)
                                        <a class="dropdown-item" href="{{ route('students.show', Auth::user()->student_id) }}">Profile</a>
                                    @endif
